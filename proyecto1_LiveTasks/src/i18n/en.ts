export const en = {
  ...
  ai: {
    ...
    chatSend: 'Send',
    chatClear: 'Clear',
    chatToggle: 'Open AI assistant',
    chatNotification: 'Notification',
    summaryDaily: "Today's AI summary",
    naturalError: 'Could not understand the task. Try again.',
    aiSuggested: 'AI suggestion',
    aiSuggestedBody: 'AI filled in the fields. Review and create when ready.',
    aiCreateReview: 'Review and create',
    aiCancel: 'Cancel suggestion',
